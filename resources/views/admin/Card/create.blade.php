...
@section('content')
    ...
    <div class="container mt-3">
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{route('cards.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('price') is-invalid @enderror" value="{{old('price')}}" type="number" id="price" name="price" placeholder="@lang('words.EnterPrice')">
                        @error('price') {{$message}} @enderror
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="discount">@lang('words.Discount')</label>
                        <input class="form-control @error('discount') is-invalid @enderror" value="{{old('discount')}}" type="number" id="discount" name="discount" placeholder="@lang('words.EnterDiscount')">
